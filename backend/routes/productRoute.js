...
import { placeOrder,showOrders,cancelOrder,getOrderDetails,totalOrders, allOrdersAdmin, updateOrderStatus } from '../controllers/orderController.js'
...
// show orders
router.route('/showOrders').get(isAuthenticated,showOrders)

// cancel order
router.route('/cancelOrder/:id').put(isAuthenticated,cancelOrder)

// get order details
router.route('/orderDetails/:id').get(isAuthenticated,getOrderDetails)

// total order for admin home page 
router.route('/totalOrders').get(isAuthenticated,totalOrders)
