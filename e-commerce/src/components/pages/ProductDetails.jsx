...
import ForProductDetails from "../../Loaders/ForProductDetails";
...
function ProductDetails() {
  ...
  <button
    onClick={() => {
      if (!checkLogin()) return;
      navigate(`/paymentSection/${product?.product_id}?quantity=${productQuantityForCart}`);
    }}
